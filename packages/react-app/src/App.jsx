...
import { Alert, Button, Col, Menu, Row, List, Divider, Input, InputNumber, Space } from "antd";
...
function App(props) {
  ...
  //Challenge 2: deposit any arbitrary amount
  //define component state
  const [depositAmount, setDepositAmount] = useState("00");
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>or you can</div>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.recoverContract());
                }}
              >
                🏧 recoverContract
              </Button>
